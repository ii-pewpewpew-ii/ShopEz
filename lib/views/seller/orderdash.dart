  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: StreamBuilder(
        builder: (context, snapshot) {
          switch (snapshot.connectionState) {
            case ConnectionState.active:
              if (snapshot.hasData) {
                final orders = snapshot.data as Iterable<OrderDetails>;
                final productIds = orders.map((order) => order.productId);
        ...
        stream: _cloudServices.getOrders(sellerId: email),
      ),
    );
  }
}
